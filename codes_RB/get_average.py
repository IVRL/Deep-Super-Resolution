...
parser.add_argument('--l-channel', default=True, type=lambda s: s == 'True', help='Whether to use the luminance or not (default: False)')
...
def main():
    ...
    for epoch in range(10,11):
        ...
        if (loss < minloss):
            minloss = loss
            bestep = epoch
    psnr = 10 * log10(255 * 255 / minloss)
    print("best epoch:%d, loss: %f, psnr: %f" % (bestep, minloss, psnr))
